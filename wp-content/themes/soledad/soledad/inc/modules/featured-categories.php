	...
	if( ! empty ( $fea_oj ) ) {
		...
		?>
			...
			<?php } ?>
				...
				<?php endif; ?>
				<?php if( $cat_layout == 'style-7' || $cat_layout == 'style-8' ): ?>
				...
				<div class="penci-featured-cat-seemore">
					<a href="<?php echo esc_url( get_category_link( $fea_cat_id ) ); ?>"><?php esc_html_e( 'See More', 'soledad' ); ?><i class="fa fa-angle-double-right"></i></a>
				</div>
				<?php endif; ?>
