...
<div class="mag-post-box<?php if ( $m == 1 ): echo ' first-post'; if( ! has_post_thumbnail() ): echo ' full-mag-cat'; endif;  endif; ?>">
	<div class="magcat-thumb">
		...
		?>
		<a class="penci-image-holder<?php if( $m > 1 ): echo ' small-fix-size'; endif; ?>" style="background-image: url('<?php echo penci_get_featured_image_size( get_the_ID(), 'penci-thumb' ); ?>');" href="<?php the_permalink(); ?>" title="<?php echo wp_strip_all_tags( get_the_title() ); ?>">
		</a>
