		...
		<div class="penci-mag2-carousel-content" data-auto="<?php echo esc_attr( $data_auto ); ?>" data-autotime="<?php echo esc_attr( $auto_time ); ?>" data-speed="<?php echo esc_attr( $auto_speed ); ?>">
			<?php if ( $feat_query->have_posts() ) {
				...
				while ( $feat_query->have_posts() ): $feat_query->the_post();
					...
					$thumb_size = 'penci-thumb';
					if ( ! $flag ) {
						$thumb_size = 'penci-magazine-slider';
					}
					?>
					<div class="mag2-item">
						<div class="mag2-thumbnail">
							<div class="mag-img" style="background-image: url('<?php echo penci_get_featured_image_size( get_the_ID(), $thumb_size ); ?>');" title="<?php echo wp_strip_all_tags( get_the_title() ); ?>">

								<a href="<?php the_permalink(); ?>" class="mag2slider-overlay">
