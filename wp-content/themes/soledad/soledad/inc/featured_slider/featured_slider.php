		...
		<?php if ( $feat_query->have_posts() ) : while ( $feat_query->have_posts() ) : $feat_query->the_post(); ?>
			<figure class="item">
				...
				<div class="wrapper-holder">
					<div class="penci-image-holder slider-<?php echo $featured_style; ?>-fix" style="background-image: url('<?php echo penci_get_featured_image_size( get_the_ID(), $img_thumb ); ?>');">
				</div>
